...
public class PaymentController {
	...
	public ResponseEntity<Payment> getPaymentById(@PathVariable @Valid Long paymentId) {
		try {
	...
	public ResponseEntity<String> updatePayment(@PathVariable @Valid Long paymentId, @RequestBody @Valid Payment updatedPayment) {
		try {
	...
	public ResponseEntity<String> deletePayment(@PathVariable @Valid Long paymentId) {
		try {
